...
const translations: Record<string, Record<Lang, string>> = {
  ...
  subscriptionValid: { pt: 'Assinatura Válida', en: 'Valid Subscription', es: 'Suscripción Válida' },
  trialPeriod: { pt: 'Período de Teste', en: 'Trial Period', es: 'Período de Prueba' },
  remainingDays: { pt: 'dias restantes', en: 'days remaining', es: 'días restantes' },
